mainSystemModule.controller('GridRafflePrizeController', ['$scope', '$state', '$rootScope', '$modal', 'RafflePrizeService', function(s, st, rs, m, rp) { // USER GRID
	...
	s.filterColumn = "id"; // DEFAULT Filter Column Dropdown
	...
	s.columns = [
		{ 'label': 'Prize ID', 'field': 'id'},
		{ 'label': 'Prize Name', 'field': 'prizeItem'},
		{ 'label': 'Prize Description', 'field': 'prizeItemDesc'},
		{ 'label': 'Reward Program', 'field': 'rewardsProgram'},
		{ 'label': 'Created By', 'field': 'createdBy'},
		{ 'label': 'Created Date', 'field': 'createdDate'}
	];

	function refreshGrid() { 
		s.result = rp.getAll(function(result){
			console.log("Displayed result : ", result._embedded.rafflePrizes);
			s.data = result._embedded.rafflePrizes;
