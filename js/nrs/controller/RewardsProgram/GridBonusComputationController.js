angular.module("mainSystemModule").controller('GridBonusComputationController', ['$scope', '$state', '$stateParams', 'ReferenceTableService', '$modal', function(s, rt, sp, r, m) { // Form Initializer
	...
	s.bdoTable = {
		row: { // Table Row Buttons
			edit: function (index, row) {
				...
				m.open( {
					templateUrl: 'js/nrs/view/rewardsprogram/computations/bonuscomputation/form.html',
	...
	s.$on('bonusComputation', function () {
