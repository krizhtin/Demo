angular.module("mainSystemModule").controller('GridPointsExpiryController', ['$scope', '$state', '$stateParams', 'ReferenceTableService', '$modal', function(s, rt, sp, r, m) { // Form Initializer
	...
	s.data = [
		...
		{"label":"4l", "condition":"4c", "formula":"4f", "remarks":"4r"},
		{"label":"5l", "condition":"5c", "formula":"5f", "remarks":"5r"},
		{"label":"6l", "condition":"6c", "formula":"6f", "remarks":"6r"}
	];
	...
	s.bdoTable = {
		row: { // Table Row Buttons
			edit: function (index, row) {
				...
				m.open( {
					templateUrl: 'js/nrs/view/rewardsprogram/computations/pointsexpiry/form.html',
