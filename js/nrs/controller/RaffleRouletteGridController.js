mainSystemModule.controller('RaffleRouletteGridController', ['$scope', 'UserService', '$state', 'GroupService', '$rootScope', '$modal', function(s, u, st, als, rs, m) { // USER GRID
	...
	s.startroulette = function() { // start roulette
		validate(function(){
			...
			nz_init_confirmMessage("Are you sure you want to draw?", function(){
				m.open( {
					templateUrl: '../bdo-angular/js/nrs/view/raffleroulette/modal/form.html',
					controller: ['$scope', '$modalInstance', function(s, mi) {
						...
						s.drawStop = function(){
							...
							m.open( {
								templateUrl: '../bdo-angular/js/nrs/view/raffleroulette/modal/winner.html',
								controller: ['$scope', '$modalInstance', function(s, mi) {
