mainSystemModule.controller('FormMonitorUsersController', ['$scope', '$http', 'UserService', '$state', '$stateParams', 'BankService', 'AccessLevelService', 'GroupService', function(s, h, u, st, e, b, a, g, nzV) { // Form Initializer
